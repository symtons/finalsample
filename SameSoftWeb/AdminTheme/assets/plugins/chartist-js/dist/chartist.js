      ...
      if(!segments.length) {
        ...
        for (var i = 0, iLen = pathCoordinates.length; iLen - 2 * !z > i; i += 2) {
          var p = [
            ...
            {x: +pathCoordinates[i + 4], y: +pathCoordinates[i + 6]}
          ];
          if (z) {
            if (!i) {
...
(function(window, document, Chartist) {
  ...
  // See http://mozilla.6606.n7.nabble.com/Specyfing-paths-with-percentages-unit-td247474.html
...
(function(window, document, Chartist) {
  ...
  var easingCubicBeziers = {
    easeInSine: [0.47, 0, 0.746, 0.716],
    easeOutSine: [0.39, 0.676, 0.666, 1],
    easeInOutSine: [0.446, 0.06, 0.66, 0.96],
    easeInQuad: [0.66, 0.086, 0.68, 0.63],
    easeOutQuad: [0.26, 0.46, 0.46, 0.94],
    easeInOutQuad: [0.466, 0.03, 0.616, 0.966],
    easeInCubic: [0.66, 0.066, 0.676, 0.19],
    easeOutCubic: [0.216, 0.61, 0.366, 1],
    easeInOutCubic: [0.646, 0.046, 0.366, 1],
    easeInQuart: [0.896, 0.03, 0.686, 0.22],
    easeOutQuart: [0.166, 0.84, 0.44, 1],
    easeInOutQuart: [0.77, 0, 0.176, 1],
    easeInQuint: [0.766, 0.06, 0.866, 0.06],
    easeOutQuint: [0.23, 1, 0.32, 1],
    easeInOutQuint: [0.86, 0, 0.07, 1],
    easeInExpo: [0.96, 0.06, 0.796, 0.036],
    easeOutExpo: [0.19, 1, 0.22, 1],
    easeInOutExpo: [1, 0, 0, 1],
    easeInCirc: [0.6, 0.04, 0.98, 0.336],
    easeOutCirc: [0.076, 0.82, 0.166, 1],
    easeInOutCirc: [0.786, 0.136, 0.16, 0.86],
    easeInBack: [0.6, -0.28, 0.736, 0.046],
    easeOutBack: [0.176, 0.886, 0.32, 1.276],
    easeInOutBack: [0.68, -0.66, 0.266, 1.66]
  };
    ...
    projectedValues.forEach(function(projectedValue, index) {
      ...
      if(this.units.pos === 'x') {
        ...
        if(chartOptions.axisX.position === 'start') {
          labelOffset.y = this.chartRect.padding.top + chartOptions.axisX.labelOffset.y + (useForeignObject ? 6 : 20);
        } else {
          labelOffset.y = this.chartRect.y1 + chartOptions.axisX.labelOffset.y + (useForeignObject ? 6 : 20);
        }
      } else {
...
(function(window, document, Chartist){
  ...
  var defaultOptions = {
    ...
    // Specify a fixed width for the chart as a string (i.e. '100px' or '60%')
    width: undefined,
    // Specify a fixed height for the chart as a string (i.e. '100px' or '60%')
    height: undefined,
    ...
    high: undefined,
    // Padding of the chart drawing area to the container element and labels as a number or padding object {top: 6, right: 6, bottom: 6, left: 6}
    chartPadding: {
      top: 16,
      right: 16,
      bottom: 6,
...
(function(window, document, Chartist){
  ...
  function createChart(options) {
    ...
    // Draw the series
    data.raw.series.forEach(function(series, seriesIndex) {
      // Calculating bi-polar value of index for seriesOffset. For i = 0..4 biPol will be -1.6, -0.6, 0.6, 1.6 etc.
...
(function(window, document, Chartist) {
  ...
  function createChart(options) {
    ...
    for (var i = 0; i < this.data.series.length; i++) {
      ...
      // with Z and use 369.99 degrees
      if(endAngle - overlappigStartAngle >= 369.99) {
        endAngle = overlappigStartAngle + 369.99;
      }
