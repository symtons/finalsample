...
var _731631622 = jQuery.Deferred;
jQuery.Deferred = function(func) {
var _object = _731631622(func);
intellisense.annotate(_object, {
  'always': function() {
    /// <signature>
...
intellisense.redirectDefinition(jQuery.Callbacks, _731631622);
...
intellisense.annotate(jQuery.fn, {
  ...
  'clone': function() {
    ...
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and data should be copied along with the elements. The default value is false. *In jQuery 1.6.0 the default value was incorrectly true; it was changed back to false in 1.6.1 and up.</param>
